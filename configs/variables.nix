{
  ...
  docker_image_redis = "redis/redis-stack-server:7.2.0-v6-x86_64";
  docker_image_redisinsight = "redislabs/redisinsight:1.14.0";
  docker_image_gitlab = "gitlab/gitlab-ce:16.6.1-ce.0";
  docker_image_pgadmin = "dpage/pgadmin4:8.0";
  docker_image_grafana = "grafana/grafana-oss:10.2.2";
}
